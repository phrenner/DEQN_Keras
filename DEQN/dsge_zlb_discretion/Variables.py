...
# end_state.append({'name':'pi_tot_x'})
...
definitions = []
definitions.append({'name':'i_nom_y', 'bounds': {'upper': 0.1, 'penalty_upper': 1.0, 'lower': 0., 'penalty_lower': 1}})
...
definitions.append({'name':'F_fun_y'})
definitions.append({'name':'G_fun_y'})
definitions.append({'name':'H_fun_y'})
definitions.append({'name':'num_y', 'bounds': {'upper': 12.0, 'penalty_upper': 1.}})
definitions.append({'name':'den_y', 'bounds': {'upper': 12.0, 'penalty_upper': 1.}})
...
definitions.append({'name':'varphi_y', 'bounds': {'lower': -1, 'penalty_lower': 1}})

definitions.append({'name':'dV_dDelta'})
definitions.append({'name':'dF_dDelta'})
definitions.append({'name':'dG_dDelta'})
definitions.append({'name':'dH_dDelta'})
