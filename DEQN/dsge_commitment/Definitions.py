...
def zeta_y(state, policy_state):
    ...
    return -(c_t**(-gamma) * (vartheta_old * epsilon * pi_aux_t * Xi_N_t * c_old**gamma 
                              - eta_t * c_t**gamma * pi_aux_t**((epsilon-1)/epsilon)
                              + epsilon * eta_t * c_t**gamma * pi_aux_t**((epsilon-1)/epsilon)
                              - rho_old * Xi_D_t * c_old**gamma * pi_aux_t**((epsilon-1)/epsilon)
                              + epsilon * rho_old * Xi_D_t * c_old**gamma * pi_aux_t**((epsilon-1)/epsilon))
                              )/(epsilon * pi_aux_t * Delta_old)
