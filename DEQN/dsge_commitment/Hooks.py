from Parameters import policy, states, ENABLE_TB, definitions, global_default_dtype, sigma_a_x, sigma_xi_x, rho_a_x, rho_xi_x, sigma_xi_x, sigma_g_x, rho_g_x, beta
import keras
import State
import Definitions
...
def post_init():
    ...
    normal_noise = tf.random.normal(
        [nB,4],
        mean=0.0,
        stddev=tf.constant([[0.027,0.023,0.052,0.0001]],dtype=global_default_dtype), # vartheta, rho, c, disp, i_nom, varphi
