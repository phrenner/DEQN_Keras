...
# from tensorflow.python.training.training import base as trackable
# from tensorflow.python.training.training_util import tracking
    ...
    def get_gradients_hessian(self, loss, params):
        ...
        with backend.get_graph().as_default(), backend.name_scope(self._name +
            ...
            for vi in v:
                vi[ vi < 0.5] =  -1 
                vi[ vi >= 0.5] =  1 
            v = [tf.convert_to_tensor(vi, dtype = self.default_dtype) for vi in v]
